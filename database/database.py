...
def insert_into_apartments(dataframe: pd.DataFrame) -> None:
    ...
    for row in list_of_tuples:
        ...
        query = f"INSERT INTO apartments (room_count, sq_meters, apartment_floor, area, total_floors, building_age, predicted_price) VALUES ('{room_count}', '{sq_meters}', '{apartment_floor}', '{area}', '{total_floors}', '{building_age}', '{predicted_price}');"
        try:
